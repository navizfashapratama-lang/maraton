...
<head>
    ...
    <title>Tambah Event - Staff Area</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3">
                <i class="fas fa-calendar-plus text-primary"></i> Tambah Event Baru
            </h1>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('staff.events.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="kategori" name="kategori" 
                                   required value="{{ old('kategori') }}" placeholder="5K, 10K, Half Marathon, dll">
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="rute_lomba" name="rute_lomba" 
                                      rows="3">{{ old('rute_lomba') }}</textarea>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control" id="syarat_ketentuan" name="syarat_ketentuan" 
                                      rows="3">{{ old('syarat_ketentuan') }}</textarea>
                        </div>
